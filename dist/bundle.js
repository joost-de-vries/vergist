...
function visiblePlaces(places) {
    return {
        type: constants.VISIBLE_PLACES,
        places: places
    };
}
exports.visiblePlaces = visiblePlaces;
function select(placeName) {
    return {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.VISIBLE_PLACES = 'VISIBLE_PLACES';
exports.SELECT = 'SELECT';
...
var registerServiceWorker_1 = __webpack_require__(26);
var redux_1 = __webpack_require__(9);
var index_1 = __webpack_require__(25);
var react_redux_1 = __webpack_require__(8);
var PlaceList_1 = __webpack_require__(24);
registerServiceWorker_1.default();
exports.store = redux_1.createStore(index_1.placeSelector, {
    places: []
});
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: exports.store },
    React.createElement(PlaceList_1.PlaceListContainer, null)), document.getElementById('root'));
...
var openlayers_1 = __webpack_require__(29);
var PlaceList_1 = __webpack_require__(28);
...
function mapDispatchToProps(dispatch) {
    return {
        onSelectClick: function (e) {
            var name = e.dispatchMarker.split('$')[1];
            dispatch(index_1.select(name));
            // Update map
            openlayers_1.updateSelection(name);
        }
    };
}
exports.mapDispatchToProps = mapDispatchToProps;
exports.PlaceListContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(PlaceList_1.PlaceList);
...
var PlaceList = (function (_super) {
    ...
    PlaceList.prototype.render = function () {
        ...
        var createItem = function (place) {
            var name = index_1.placeName(place);
            var selClass = (name == selected) ? 'selected' : '';
            return React.createElement("li", { key: name, className: selClass, onClick: onSelectClick }, name);
        };
        return (React.createElement("ul", null, this.props.places.map(createItem)));
    };
    return PlaceList;
}(React.Component));
...
function updateVisiblePlaces() {
    ...
    var places = placeLayer.getSource().getFeaturesInExtent(extent).map(function (feature) { return feature.getProperties(); });
    // Update state in Redux store
    index_1.store.dispatch(index_2.visiblePlaces(places));
}
placeLayer.on('change', updateVisiblePlaces);
map.on('moveend', updateVisiblePlaces);
function updateSelection(name) {
    var extent = map.getView().calculateExtent(map.getSize());
    var selected = placeLayer.getSource().getFeaturesInExtent(extent).filter(function (feature) { return name == index_3.placeName(feature.getProperties()); });
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(59)(module)))
